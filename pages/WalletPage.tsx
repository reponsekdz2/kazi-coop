...
const SeekerWallet: React.FC = () => {
    ...
    const renderTabContent = () => {
        switch (activeTab) {
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            <Card>
                                ...
                                <div className="flex space-x-6 mt-4 text-sm">
                                    <div>
                                        <p className="text-gray-500 dark:text-gray-400">Spent this month</p>
                                        <p className="font-semibold text-dark dark:text-light">RWF {spentThisMonth.toLocaleString()}</p>
                                    </div>
                                    <div>
                                        <p className="text-gray-500 dark:text-gray-400">Total in Savings Goals</p>
            ...
            case 'savings':
                return <Card title="Savings Goals">Your savings goals here...</Card>;
            case 'loans':
                 return <Card title="My Loans">Your loans here...</Card>;
            case 'budgeting':
        ...
        <div>
            <div className="flex flex-col md:flex-row justify-between md:items-center mb-6 gap-4">
                ...
                <div className="flex gap-2">
                    <Button variant="secondary" onClick={() => setIsWithdrawOpen(true)}>Withdraw Funds</Button>
                    <Button onClick={() => setIsDepositOpen(true)}>Deposit Funds</Button>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4 p-4 bg-light dark:bg-gray-800/50 rounded-lg">
                ...
                <div>
                     <select 
                        ...
                        className="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-dark focus:ring-2 focus:ring-primary focus:outline-none"
                    >
                        {categories.map(cat => <option key={cat} value={cat} className="capitalize">{cat === 'all' ? 'All Categories' : cat}</option>)}
                    </select>
                </div>
            </div>
    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold text-dark dark:text-light">Monthly Budgets</h2>
...
const EmployerWallet: React.FC = () => {
    ...
    return (
        <div>
            <h1 className="text-3xl font-bold text-dark dark:text-light mb-6">Company Wallet Management</h1>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <Card>
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-sm text-gray-500 dark:text-gray-400">Company Balance</p>
                 ...
                 <Card>
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-sm text-gray-500 dark:text-gray-400">Total Payouts (YTD)</p>
