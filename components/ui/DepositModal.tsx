  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Deposit Funds">
      <form onSubmit={handleSubmit} className="space-y-4">
        <p className="text-sm text-gray-500 dark:text-gray-400">Add money to your KaziCoop wallet.</p>
        <div>
        ...
        <div className="flex justify-end gap-2 pt-4">
          ...
          <Button type="submit" disabled={amount < 1000}>Confirm Deposit</Button>
        </div>
      </form>
    </Modal>
  );
